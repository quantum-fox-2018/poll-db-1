...
db.serialize((err)=>{
  ...
  db.run('CREATE TABLE IF NOT EXISTS Politicians (politician_id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT NOT NULL, party TEXT NOT NULL, location TEXT NOT NULL, grade_current REAL NOT NULL)');
